...
background = cv2.imread(r"C:\Users\sanja\OneDrive\Pictures\anime.jpg")
foreground = cv2.imread(r"C:\Users\sanja\OneDrive\Pictures\kakashi.jpg", -1)  # Use -1 flag to load image with alpha channel
